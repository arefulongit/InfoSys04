...
На данном этапе необходимо разработать систему реализующую обмен доверенной системой-источником кадровых данных и системой-приёмником между системой доверенную синхронизацию между кадровой системой и корпоративной шиной
